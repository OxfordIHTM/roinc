...
[![DOI](https://zenodo.org/badge/1347283230.svg)](https://doi.org/10.5281/zenodo.22831698)
<!-- badges: end -->
...
`{roinc}` provides a convenience function that will allow you to set
these variables in your current environment as follows:
...
produced by `jsonlite::fromJSON()`, set the argument `tabular = FALSE`
as follows:
...
`roinc_download()` functions allows for this download to be done
