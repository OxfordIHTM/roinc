...
starting from the most current LOINC version (as shown below):
    ...
    #> # A tibble: 65 × 7
    #>    version releaseDate         relmaVersion numberOfLoincs maxLoinc downloadUrl  downloadMD5Hash
    #>    <chr>   <chr>               <chr>                 <int> <chr>    <chr>        <chr>          
    #>  1 2.83    2026-08-19T00:00:00 7.16                 112405 115803-9 https://loi… 057ddf20316470…
    #>  2 2.82    2026-02-24T17:00:00 7.15                 109325 112587-1 https://loi… 1976936e2232d2…
    #>  3 2.81    2025-08-12T00:00:00 7.14                 108248 111472-7 https://loi… 09382b5adcb37c…
    #>  4 2.80    2025-02-26T00:00:00 7.13                 104672 107378-2 https://loi… e4c5f4ec8844d7…
    #>  5 2.79    2025-02-18T00:00:00 7.12                 104584 107378-2 https://loi… ffab2bb5e76117…
    #>  6 2.78    2024-08-06T00:00:00 7.11                 104054 106413-8 https://loi… b1328b30141352…
    #>  7 2.77    2024-02-27T00:00:00 7.10                 102465 104478-3 https://loi… d58f614a5ad09d…
    #>  8 2.76    2023-09-18T00:00:00 7.9                  101632 103542-7 https://loi… cc2cd40c00d3cd…
    #>  9 2.75    2023-08-15T00:00:00 7.8                  101632 103542-7 https://loi… 816cfb12de78b3…
    #> 10 2.74    2023-02-22T00:00:00 7.7                   99687 101582-5 https://loi… 7b064f2b459d43…
    #> # ℹ 55 more rows
...
and this will provide the following `tibble` output:
    ...
    #>   version releaseDate         relmaVersion numberOfLoincs maxLoinc downloadUrl   downloadMD5Hash
    #>   <chr>   <chr>               <chr>                 <int> <chr>    <chr>         <chr>          
    #> 1 2.83    2026-08-19T00:00:00 7.16                 112405 115803-9 https://loin… 057ddf20316470…
...
#> [1] "/tmp/RtmpmJTJfS/loinc_2.80.zip"
```
...
#>  1 97510-2   Glucose m… NFr      RptPeriod  Inter… Qn        Calculated CHEM  2.79              
#>  2 2352-3    Glucose C… RelMCnc  Pt         Plas+… Qn        <NA>       CHEM  2.42              
#>  3 25670-1   Glucose^3… MCnc     Pt         Urine  Qn        <NA>       CHAL  2.73              
#>  4 25675-0   Glucose^4… MCnc     Pt         Urine  Qn        <NA>       CHAL  2.73              
#>  5 26545-4   Glucose^6… MCnc     Pt         Urine  Qn        <NA>       CHAL  2.34              
#>  6 26540-5   Glucose^3… MCnc     Pt         Urine  Qn        <NA>       CHAL  2.73              
#>  7 26542-1   Glucose^5… MCnc     Pt         Urine  Qn        <NA>       CHAL  2.34              
#>  8 18296-4   Glucose^p… Imp      Pt         Ser/P… Nom       <NA>       CHAL  2.26              
#>  9 47622-6   Glucose^p… SCnc     Pt         Ser/P… Qn        <NA>       CHAL  2.73              
#> 10 108027-4  Glucose    {Measur… -          Urine  -         <NA>       LABO… 2.81              
#> # ℹ 40 more rows
#> # ℹ 38 more variables: CHNG_TYPE <chr>, DefinitionDescription <chr>, STATUS <chr>,
#> #   CLASSTYPE <int>, FORMULA <lgl>, ExampleAnswers <chr>, SURVEY_QUEST_TEXT <chr>,
#> #   SURVEY_QUEST_SRC <lgl>, UNITSREQUIRED <chr>, RELATEDNAMES2 <chr>, SHORTNAME <chr>,
#> #   ORDER_OBS <chr>, HL7_FIELD_SUBFIELD_ID <lgl>, EXTERNAL_COPYRIGHT_NOTICE <lgl>,
#> #   EXAMPLE_UNITS <chr>, LONG_COMMON_NAME <chr>, EXAMPLE_UCUM_UNITS <chr>, STATUS_REASON <chr>,
#> #   STATUS_TEXT <lgl>, CHANGE_REASON_PUBLIC <chr>, COMMON_TEST_RANK <int>, …
```
...
which returns:
    ...
    #>  1 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  2 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  3 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  4 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  5 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  6 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  7 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  8 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #>  9 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> 10 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> 11 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> 12 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> 13 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> 14 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> 15 Bundle       9afd0488-4579-47c6-8064-74382… 2026-09-… sear…    15 self          https://fhir…
    #> # ℹ 27 more variables: link$url <chr>, entry$resourceType <chr>, $id <chr>, $versionId <chr>,
    #> #   $lastUpdated <chr>, $system <chr>, $code <chr>, $url <chr>, $identifier <list>,
    #> #   $version <chr>, $name <chr>, $title <chr>, $status <chr>, $experimental <lgl>, $date <chr>,
    #> #   $publisher <chr>, $contact <list>, $description <chr>, $copyright <chr>,
    #> #   $caseSensitive <lgl>, $valueSet <chr>, $hierarchyMeaning <chr>, $compositional <lgl>,
    #> #   $versionNeeded <lgl>, $content <chr>, $count <int>, $property <list>
...
which returns
    ...
    #> 
    #> $id
    #> [1] "b73872de-0574-4b11-807f-8aef8a77ce17"
    #> 
    #> $meta
    #> $meta$lastUpdated
    #> [1] "2026-09-18T17:27:23.103+00:00"
    #> 
    #> 
    #> $type
    #> [1] "searchset"
...
which returns
    ...
    #> $expansion
    #> $expansion$id
    #> [1] "c9418e1b-c1e5-4907-abbf-bae96d5aa65c"
    #> 
    #> $expansion$identifier
    #> [1] "eebbc1b0-75a7-4055-839e-49fb89b6289c"
    #> 
    #> $expansion$timestamp
    #> [1] "2026-09-18T17:27:23+00:00"
    #> 
    #> $expansion$total
    #> [1] 5
    #> 
